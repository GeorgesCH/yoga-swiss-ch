...
// Create a new thread
app.post('/community/threads', async (c) => {
  try {
...
app.get('/community/threads/:orgId', async (c) => {
  try {
...
// Send a message
app.post('/community/messages', async (c) => {
  try {
...
app.get('/community/messages/:threadId', async (c) => {
  try {
...
// Flag a message
app.post('/community/messages/:messageId/flag', async (c) => {
  try {
...
app.get('/community/moderation/:orgId', async (c) => {
  try {
    const orgId = c.req.param('orgId');
...
app.put('/community/moderation/:itemId', async (c) => {
  try {
...
app.post('/community/class-thread', async (c) => {
  try {
...
// Get class threads
app.get('/community/class-threads/:orgId', async (c) => {
  try {
    const orgId = c.req.param('orgId');
...
app.put('/community/class-thread/:threadId/archive', async (c) => {
  try {
    const threadId = c.req.param('threadId');
...
// Create notification
app.post('/community/notifications', async (c) => {
  try {
...
app.get('/community/notifications/:userId', async (c) => {
  try {
...
app.put('/community/notifications/:notificationId/read', async (c) => {
  try {
...
app.put('/community/notifications/:userId/mark-all-read', async (c) => {
  try {
    const userId = c.req.param('userId');
...
app.get('/community/templates/:orgId', async (c) => {
  try {
    const orgId = c.req.param('orgId');
...
app.post('/community/upload', async (c) => {
  try {
