-- =====================================================
-- YogaSwiss Complete Database Initialization
-- Switzerland's #1 Yoga Platform - Production Database Setup
-- =====================================================

-- This script initializes the complete YogaSwiss database schema
...
INSERT INTO system_alerts (
  ...
  'YogaSwiss complete database schema has been successfully initialized with all tables, indexes, and triggers.'
);

-- Show completion summary
SELECT 
  'YogaSwiss Database Schema Initialization Complete!' as message,
